...
def rodar_simulacao():
    ...
    geladeira = GeladeiraFisica(temp_inicial=10.0, vol_inicial=8.0) # Começa quente (25°C) e Cheia (8.0)
    ...
    # Cada rodada representa um passo de tempo
    for t in range(500):
        
        # A. Atualiza o mundo (Física)
        geladeira.atualizar_ambiente_externo(t)
        geladeira.simular_eventos_usuario(t) 
